...
vim.keymap.set('n', '<leader>gl', '<cmd>lua require("telescope").extensions.git_worktree.git_worktrees()<CR>', { desc = 'Git Worktree' })
vim.keymap.set('n', '<leader>ga', '<cmd>lua require("telescope").extensions.git_worktree.create_git_worktree()<CR>', { desc = 'Create Git Worktree' })
